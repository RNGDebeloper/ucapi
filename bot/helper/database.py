...
class Database:
    ...
    async def add_tgfiles(self, chat_id, file_id, hash, name, size, file_type, tmdb_id=None, tmdb_type=None, season=None, episode=None, poster_url=None):
        ...
        file = {"chat_id": chat_id, "msg_id": file_id,
                ...
                "tmdb_id": tmdb_id, "tmdb_type": tmdb_type, "season": season,
